      ...
      <DialogContent className="sm:max-w-[500px] max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center text-xl">
            <User className="mr-2 h-6 w-6 text-institutional-blue" />
            ...
            <div key={num} className="flex items-center">
              ...
              {num < 3 && (
                <div className={`w-16 h-1 mx-2 ${
                  num < step ? 'bg-institutional-blue' : 'bg-gray-200'
                }`} />
              )}
            </div>
          ))}
        ...
        {step === 1 && (
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="voterTitle">Número do Título de Eleitor</Label>
              <div className="relative">
                <Input
                  id="voterTitle"
              ...
              {validationStatus.voterTitle === 'invalid' && (
                <p className="text-sm text-red-500 mt-1">Título de eleitor inválido</p>
              )}
            </div>
        ...
        {step === 2 && (
          <div className="space-y-6">
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-institutional-blue mb-2 flex items-center">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                />
                <div>
                  <Label htmlFor="acceptResponsibility" className="text-sm">
        ...
        {step === 3 && (
          <div className="text-center space-y-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-institutional-navy mb-2">
